      ...
      <Container style={{color:'white'}} className="py-5">
        <Row className="d-flex align-items-center">
          <Col sm={12} md={{span:4,order:'first'}} className="text-center text-lg-start">
            <h4 className="fst-italic" style={{color:'rgb(154,106,255)'}}>{text.cardad.perks}</h4>
          ...
          <Col sm={12} md={4} className="text-center text-lg-start">
            <h4 className="fst-italic" style={{color:'rgb(154,106,255)'}}>{text.cardad.points}</h4>
            <p>{text.cardad.pointsdes}</p>
            <h4 className="fst-italic" style={{color:'rgb(154,106,255)'}}>{text.cardad.rewards ? text.cardad.rewards : 'Rewards' }</h4>
